...
<tr><td><input type="radio" name="aStatus" value=21 <? if ($allowStatus == "P-Banned") echo"checked=\"true\"";?>><? echo "$font";?>Permanent Ban - Place a permanent Ban</font></td></tr>
<tr><td><input type="radio" name="aStatus" value=22 <? if ($allowStatus == "T-Banned") echo"checked=\"true\"";?>><? echo "$font";?>Temporary Ban - Place under temporary Ban</font></td></tr>
