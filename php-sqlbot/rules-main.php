...
if ($function == updateclient){
	$sql = "UPDATE client_rules SET client='$ud_client', min_version='$ud_min_version',
		...
		min_connection='$ud_min_connection',client_name='$ud_client_name',min_limit='$ud_min_limit'
...
<table border="1" cellspacing="2" cellpadding="2"><tr>
		...
		<th><?php  echo "$font"; ?>Min Limit<?php  echo "$fontend"; ?></th>
...
while ($i < $num) {
	...
	<td nowrap><?php  echo "$font$min_limit$fontend"; ?></td>
	...
	<form action="rules-main.php?function=delclient&id=<?php  echo "$id";?>" method="post">
