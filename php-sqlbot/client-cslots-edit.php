...
<html>
<head>
<title>Connection Slots Settings</title>
</head>
<body>
<?
include("dbinfo.inc.php");
echo "<h3><center>ODCH Admin - Update Connection Slots Settings for $hubname</h3></center><br>";
...
?>
		<form action="<? echo "connectionslots.php?function=update" ?>" method="post">
